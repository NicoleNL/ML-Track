...
# log_path =  user_outpath
# elk_outpath = json_path + 'elk_outpath/'
# email = "nger.ling.chong@intel.com"

#read config file and call the other functions
def main(ml_type):    
    
    #specify the paths #SUBJECT TO CHANGE  
    json_path = 'C:/Users/nchong/OneDrive - Intel Corporation/Documents/Debug Similarity Analytics and Bucketization Framework/ML_Testing/'
    user_outpath = json_path + 'user_outpath/'
    elk_outpath = json_path + 'elk_outpath/'
    log_path =  user_outpath
    ...
    if ml_type == "supervised":
        config_name = "config_supervised.json" #supervised
    if ml_type == "unsupervised":
        config_name = "config_unsupervised.json" #unsupervised,similarity metrics
        
    with open(json_path+config_name) as config_file:
...
#    word_contractions
   ...
   #Remove html tag and url
    ...
    #         df_out["cluster"]=lda(column=df,n_components=n_components,top_n_terms=top_n_terms,ngram_range=ngram_range)            
    ...
    #         df_out["cluster"]=nmf(column=df,n_components=n_components,top_n_terms=top_n_terms,fe_type=fe_type,ngram_range=ngram_range)              
